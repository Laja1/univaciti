    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            "file:text-foreground placeholder:text-xs placeholder:text-muted-foreground selection:bg-primary bg-white border-[#E5E5E5] selection:text-primary-foreground dark:bg-input/30 h-11 w-full min-w-0 rounded-lg border  px-3 py-1 text-xs shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
